...
- **Enemies are capsule/sphere primitives** with procedural materials — readable placeholders, not final character art. Replace with rigged models when available (same pattern as the player GLB).
