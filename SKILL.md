...
- **Web build first-load is ~96MB** (38MB wasm engine fixed + 20MB breacher.glb + 13MB Meshy textures + ~4.5MB audio). Heavy on mobile data. Optimization candidates (not yet done): downscale Meshy textures to 1K, compress audio import (QOA/Vorbis), decimate/strip-unused-anims on breacher.glb in Blender. Desktop FPS is fine regardless.
